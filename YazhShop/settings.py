...
EMAIL_SUBJECT_PREFIX = '[Yazh Shop] '
...
SECRET_KEY = os.environ.get('SECRET_KEY','UajFCuyjDKmWHe29neauXzHi9eZoRXr6RMbT5JyAdPiACBP6Cra2')
...
THUMBNAIL_KEY_PREFIX = 'yazh-shop'
THUMBNAIL_KVSTORE = os.environ.get(
    'THUMBNAIL_KVSTORE','sorl.thumbnail.kvstores.cached_db_kvstore.KVStore')
THUMBNAIL_REDIS_URL = os.environ.get('THUMBNAIL_REDIS_URL',None)
